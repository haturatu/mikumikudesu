...
class MotionEditor {
  public:
    ...
    [[nodiscard]] static std::vector<MotionKeyRef> paste(MotionDocument& document, const MotionClipboard& clipboard,
...
class EditMotionCommand final : public EditCommand {
  public:
    EditMotionCommand(ModelId target, bool global, VmdMotion before, VmdMotion after, std::string label = "Edit motion")
